...
function fp() {
 echo `find $HOME/Projects/Oomph $HOME/Projects/Pelofy $HOME/Projects/mogeneration/oomph-build $HOME/Projects/Personal $HOME/Projects/open_source $HOME/Projects/NewsDigital -maxdepth 1 | grep /\[\^/\]\*$1\
\[\^/\]\*$ | head -n 1`
}
