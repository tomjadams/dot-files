...
function fp() {
 echo `find $HOME/Projects/mogeneration $HOME/Projects/mogeneration/oomph-build $HOME/Projects/Personal $HOME/Projects/OpenSource $HOME/Projects/NewsDigital -maxdepth 1 | grep /\[\^/\]\*$1\
\[\^/\]\*$ | head -n 1`
}
